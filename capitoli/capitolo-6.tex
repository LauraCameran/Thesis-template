...
\begin{itemize}
    ...
    \item \bd{codesmell}:  un problema di manutenibilità che rende il codice confuso e difficile da manutenere.
\end{itemize}
...
L'attività di testing per quel che riguarda i test di unità è stata svolta utilizzando principalmente due framework: JUnit e Mockito.
    ...
    \begin{itemize}
        \item \txt{Test} per indicare che il metodo rappresenta un test;
