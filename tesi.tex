...
\usepackage[backend=biber,hyperref,backref,citestyle=numeric]{biblatex}
...
%TODO sistemare gli hyperref e sistemare label
...
% BW Per il bianco e nero
% \colorlet{beautyblue}{white}
